...
class FileMode:
    ...
    def register_callbacks(self, app):
        ...
        def handle_mode_change(new_mode, model_layout, o1, o2):
            if o1 or o2:
                return no_update, [], False, False, no_update, no_update
            ...
            if not file_path or not file_path.startswith("WORKSPACE"):  # if local file open
                return "read", [], False, False, no_update, no_update
            ...
            if ctx.triggered_id == "file-mode-control":
                if new_mode == "edit":
                    ...
                    if lock:
                        ...
                        return "read", [], no_update, no_update, no_update, no_update
                    return "read", [], True, False, self.ENTER_TEXT, no_update
                else:
                    return "edit", [], False, True, no_update, self.EXIT_TEXT
        ...
        def enter_edit(n, model_layout, checked):
            ...
            if enter_edit_mode(file_path):
                ...
                return "edit", [], no_update, updated_columnDefs, False
            else:
                return no_update, [], False, no_update, False
