...
class ResultViewer:
    ...
    def layout(self):
        ...
        fl_config = {
            "global": {"enableSingleTabStretch": True, "tabEnableClose": True, "tabEnableFloat": False, "tabEnableDrag": True, "tabSetEnableDrop": True, "tabEnableRename": False, "splitterSize": 4, "tabSetHeaderHeight": 32},  # 탭 닫기 기능 전역 활성화  # 탭 플로팅 기능 전역 활성화  # 탭 드래그 기능 전역 활성화  # 탭 드롭 기능 전역 활성화  # 탭 이름 변경 비활성화  # 스플리터 크기 설정  # 탭 헤더 높이 설정
            "borders": [
                {
                    "type": "border",
                    "location": "top",
                    ...
                    "size": 38,
                    "children": [
                        {"type": "tab", "name": "Home", "id": "home-item", "enableDrop": False, "enableDrag": False, "enableClose": False, "enableFloating": False},
                        {"type": "tab", "name": "View", "id": "view-item", "enableDrop": False, "enableDrag": False, "enableClose": False, "enableFloating": False},
                        {"type": "tab", "name": "Edit", "id": "edit-item", "enableDrop": False, "enableDrag": False, "enableClose": False, "enableFloating": False},
                        {"type": "tab", "name": "Waive", "id": "waive-item", "enableDrop": False, "enableDrag": False, "enableClose": False, "enableFloating": False},
                        {"type": "tab", "name": "Script", "id": "script-item", "enableDrop": False, "enableDrag": False, "enableClose": False, "enableFloating": False},
                        {"type": "tab", "name": "Crossprobe", "id": "crossprobe-item", "enableDrop": False, "enableDrag": False, "enableClose": False, "enableFloating": False},
                    ],
                },
                {
                    "type": "border",
                    ...
                    "selected": 0,
                    "size": 200,
                    "children": [{"type": "tab", "name": "Console", "component": "text", "id": "console-tab"}, {"type": "tab", "name": "Log", "component": "text", "id": "log-tab"}],
            ...
            "layout": {
                ...
                "weight": 100,
                "children": [
                    {"type": "tabset", "weight": 80, "children": [{"type": "tab", "name": "DataGrid", "component": "grid", "id": "grid-tab", "enableClose": False, "enableDrag": False, "enableFloat": False}], "enableDrop": False, "enableSplit": False, "enableMaximize": True},  # 메인 그리드 탭셋에 드롭 불가능  # 메인 그리드 탭셋 분할 불가능  # 최대화는 가능
                    # {
                    #     "type": "tabset",
                    #     "weight": 20,
                    #     "children": [
    ...
    def register_callbacks(self, app):
        ...
        def AgGrid_height(layout_config):
            ...
            return {"height": f"calc(100vh - 150px - {top_size}px - {bottom_size}px)", "width": "100%", "overflow": "auto"}
